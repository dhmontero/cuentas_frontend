 ...
 * T_CNTASTHKYYPOH_380 - frmCrearCuenta 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASTHKYYPOH_380")
@Component
@Service({T_CNTASTHKYYPOH_380.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASTHKYYPOH_380)(task.version=1.0.0))")
,@Reference(name="VW_FRMCREAREU_568", 
...
,@Reference(name="Q_CLIETNEE_OB83",
    ...
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CLIETNEE_OB83)(query.version=1.0.0))")
...
public class T_CNTASTHKYYPOH_380 {
