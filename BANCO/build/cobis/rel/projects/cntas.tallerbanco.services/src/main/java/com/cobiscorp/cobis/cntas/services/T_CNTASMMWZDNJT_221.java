/*
 * Archivo: T_CNTASMMWZDNJT_221.java
 * Fecha: 2020-12-29T01:51:06Z
 *
 ...
 * T_CNTASMMWZDNJT_221 - formConsultaTransaccion 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASMMWZDNJT_221")
@Component
@Service({T_CNTASMMWZDNJT_221.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASMMWZDNJT_221)(task.version=1.0.0))")
,@Reference(name="VW_TRANSACCII_736", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TRANSACCII_736)(view.version=1.0.0))")
,@Reference (name="QV_AV37_VTU36",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_AV37_VTU36)")
,@Reference(name="Q_TRANIIOA_KE37",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_TRANIIOA_KE37)(query.version=1.0.0))")
...
public class T_CNTASMMWZDNJT_221 {
