...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI5042_bli_insertar_cahorros")
})
public class BLI5042_bli_insertar_cahorros implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI5042_bli_insertar_cahorros.class);
  ...
  public void execute(DynamicRequest dynamicRequest) {
    ...
    try {
      ...
      mapper.addInputParameter("@t_trn", SqlType.INT, "706712");
      ...
      boolean ret = mapper.execute(".cobis.g3_sp_cuenta_ahorros");
