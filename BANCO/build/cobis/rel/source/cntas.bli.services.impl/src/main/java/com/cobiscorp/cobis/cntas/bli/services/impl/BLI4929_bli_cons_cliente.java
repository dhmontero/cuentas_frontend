...
@Properties({
  ...
  @Property(name = "bli.id", value = "BLI4929_bli_cons_cliente")
})
public class BLI4929_bli_cons_cliente implements IBLIExecutor {
  private static final ILogger logger = LogFactory.getLogger(BLI4929_bli_cons_cliente.class);
