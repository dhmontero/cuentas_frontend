/*
 * Archivo: T_CNTASEHKHATKR_667.java
 * Fecha: 2020-12-29T23:25:41Z
 *
 ...
 * T_CNTASEHKHATKR_667 - formTransferencia 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASEHKHATKR_667")
@Component
@Service({T_CNTASEHKHATKR_667.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASEHKHATKR_667)(task.version=1.0.0))")
,@Reference(name="VW_TRANSFEREE_554", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_TRANSFEREE_554)(view.version=1.0.0))")
,@Reference (name="QV_MN24_MNM48",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_MN24_MNM48)")
,@Reference(name="Q_CUENAAAA_US24",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CUENAAAA_US24)(query.version=1.0.0))")
...
public class T_CNTASEHKHATKR_667 {
