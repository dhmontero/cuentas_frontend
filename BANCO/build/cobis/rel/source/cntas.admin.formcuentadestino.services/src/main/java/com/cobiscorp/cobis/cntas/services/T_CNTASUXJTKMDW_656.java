/*
 * Archivo: T_CNTASUXJTKMDW_656.java
 * Fecha: 2020-12-29T23:24:13Z
 *
 ...
 */
package com.cobiscorp.cobis.cntas.services;
 ...
 * T_CNTASUXJTKMDW_656 - formCuentaDestino 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASUXJTKMDW_656")
@Component
@Service({T_CNTASUXJTKMDW_656.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASUXJTKMDW_656)(task.version=1.0.0))")
,@Reference(name="VW_CUENTADEIO_794", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_CUENTADEIO_794)(view.version=1.0.0))")
,@Reference (name="QV_AR60_BTV68",
	referenceInterface=QueryViewEventBuilder.class,
	bind="addQueyViewEventBuilder",
	unbind="removeQueyViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(queryView.id=QV_AR60_BTV68)")
,@Reference(name="Q_CUENITTE_VP60",
    referenceInterface = QueryEventBuilder.class,
    bind = "addQueryEventBuilder", 
    unbind = "removeQueryEventBuilder", 
    cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
    policy=ReferencePolicy.DYNAMIC,
    target="(&(query.id=Q_CUENITTE_VP60)(query.version=1.0.0))")
...
,@Reference (name="AutocrudService",
	referenceInterface=com.cobiscorp.designer.api.infrastructure.IAutocrudService.class,
	bind="addAutocrudService",
	unbind="removeAutocrudService",
	cardinality = ReferenceCardinality.OPTIONAL_UNARY, 
	policy=ReferencePolicy.DYNAMIC)
})
public class T_CNTASUXJTKMDW_656 {
	...
	@POST
	@Path("/crud")
	public cobiscorp.ecobis.designer.transaction.dto.TransactionResponse  executeAutocrud(cobiscorp.ecobis.designer.transaction.dto.TransactionRequest transactionRequest){
	...
	* Servicio autocrud
	**/
	private com.cobiscorp.designer.api.infrastructure.IAutocrudService autocrudService;
	 ...
	 **/
	public void addAutocrudService(com.cobiscorp.designer.api.infrastructure.IAutocrudService autocrudService){
	 ...
	 *  @param autocrudService servicio de autocrud
	 **/
	public void removeAutocrudService(com.cobiscorp.designer.api.infrastructure.IAutocrudService autocrudService){
