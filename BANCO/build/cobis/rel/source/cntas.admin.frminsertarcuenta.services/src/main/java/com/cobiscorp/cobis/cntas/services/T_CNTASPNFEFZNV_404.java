/*
 * Archivo: T_CNTASPNFEFZNV_404.java
 * Fecha: 2020-12-30T14:34:12Z
 *
 ...
 * T_CNTASPNFEFZNV_404 - frmInsertarCuenta 
 *
 */
@Path("/CNTAS/ADMIN/T_CNTASPNFEFZNV_404")
@Component
@Service({T_CNTASPNFEFZNV_404.class})
@References({
@Reference(name="formEventBuilder",
	...
	target="(&(task.module=CNTAS)(task.submodule=ADMIN)(task.id=T_CNTASPNFEFZNV_404)(task.version=1.0.0))")
,@Reference(name="VW_FRMINSERER_475", 
	referenceInterface=ViewEventBuilder.class, 
	bind = "addViewEventBuilder", 
	unbind = "removeViewEventBuilder",
	cardinality = ReferenceCardinality.OPTIONAL_MULTIPLE, 
	policy=ReferencePolicy.DYNAMIC,
	target="(&(view.id=VW_FRMINSERER_475)(view.version=1.0.0))")
...
public class T_CNTASPNFEFZNV_404 {
